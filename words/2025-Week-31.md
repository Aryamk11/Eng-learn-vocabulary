...
### 1. Lenient
*adjective*
* **Definition:** not strict in the way you punish someone or in the standard you expect.
* **Synonyms:** forgiving, sympathetic, tolerant.
* **Example:** the lenient sentences handed down by some judges.
---
### 2. Atrocious
*adjective*
* **Definition:** extremely bad.
* **Synonyms:** awful, terrible, horrible.
* **Example:** Her singing was atrocious.
---
### 3. Rudimentary
*adjective*
* **Definition:** a rudimentary knowledge or understanding of a subject is very simple and basic.
* **Synonyms:** elementary, primitive, simple, basic.
* **Example:** The tools that the ancient Egyptians used to build their temples were extremely rudimentary.
---
### 4. Volunteer
*noun / verb*

* **Definition:**
    * (n.) a person who does a job or offers help without being paid for it.
    * (v.) to offer to do something without being forced or paid to do it.
* **Synonyms:** offer, enlist, step forward, sign up, subject, participant.
* **Examples:**
    * (as a noun) The hospital relies on **volunteers** to comfort the patients.
    * (as a verb) She **volunteered** to help clean up the park after the event.
---
### 5. Bruise
*noun*
* **Definition:** a purple or brown mark on your skin that you get because you have fallen, been hit etc.
* **Synonyms:** injury, black eye, 
* **Example:** I banged into the shelf so hard that I got an ugly purple bruise on my hip.
